  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.title}>Practice Notifications</Text>
...
const styles = StyleSheet.create({
  ...
  // Day group header with hairline rule
  dayHeader: {
    paddingHorizontal: Spacing.xl,
    paddingTop: Spacing.lg,
  ...
  brassDot: {
    ...
    height: 6,
    borderRadius: 3,
    backgroundColor: Colors.secondary, // Brass dot
  },
  emptyDot: {
    width: 6,
    height: 6,
  ...
  timestampMono: {
    fontFamily: Typography.fontFamily.monoRegular, // mono timestamp
    fontSize: 10,
    color: Colors.textTertiary,
    paddingTop: 2,
  },
