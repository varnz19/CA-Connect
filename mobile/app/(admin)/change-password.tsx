...
export default function AdminChangePasswordScreen() {
  ...
  const onSubmit = async (data: PasswordForm) => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || 'Verification failed. Please verify your current password.';
        ...
        >
          <View style={styles.container}>
            ...
            <View style={styles.headerBlock}>
              ...
              <Text style={styles.pageTitle}>Change Master Password</Text>
              <Text style={styles.pageSubtitle}>
                Update your administrative login passphrase. Requires confirmation of existing password.
              </Text>
            </View>
